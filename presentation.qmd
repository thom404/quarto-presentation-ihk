...
```{.cs code-line-numbers="34-43|61-74|108-122|140-155|166-187|204-217|233-246|262-274"}
using AutoMapper;
using hpt.core;
...
```{.cs code-line-numbers="3|5-9|20|22|24-25"}
namespace hpt.core.Services
{
    public class ImageService(IFileService fileService)
    {
        ...
        /// <summary>
        /// Deletes the image files associated with the specified announcement, including the thumbnail and the image.
        /// </summary>
        /// <param name="announcement">The announcement containing the image files to be deleted.</param>
        /// <remarks>
        /// This method will delete both the thumbnail and the full-size image if they are present.
        /// </remarks>
